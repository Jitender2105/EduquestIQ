...
$pageMeta = [
    ...
    'student_report.php' => ['Student Report | EduquestIQ', 'View student-level test history, attribute scores, and detailed performance insights for school monitoring.'],
    ...
    'backend/index.php' => ['Backend Overview | EduquestIQ', 'Backend console with entity-specific administration pages for content admins and super admins.'],
